...
public class CrawljaxConfiguration {
	...
	public static class CrawljaxConfigurationBuilder {
		...
		public CrawljaxConfigurationBuilder setUseEventHandlers(boolean useStatus) {
			config.useEventHandlers = useStatus;
			return this;
		}
		
		public CrawljaxConfigurationBuilder setUseMobileUserAgent(boolean useMobile) {
			config.useMobileUserAgent = useMobile;
			return this;
		}
	...
	private boolean useEventHandlers = false;
	private boolean useMobileUserAgent = false;
	...
	public boolean getUseEventHandlers() {
		return useEventHandlers;
	}
	
	public boolean getUseMobileUserAgent() {
