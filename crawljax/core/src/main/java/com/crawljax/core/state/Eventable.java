...
public class Eventable extends DefaultEdge implements Serializable {
	...
	private ArrayList<JavaScriptError> jsErrors = new ArrayList<JavaScriptError>();
	...
	public enum EventType {
		...
		touchtap, touchdoubletap, touchtaphold, touchswiperight, touchswipeleft, touchswipeup, touchswipedown,
		mouseswiperight, mouseswipeleft, mouseswipeup, mouseswipedown
	}
	...
	void setJSErrors(ArrayList<JavaScriptError> jsErrors) {
