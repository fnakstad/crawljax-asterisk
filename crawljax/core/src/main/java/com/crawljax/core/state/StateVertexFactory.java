...
public abstract class StateVertexFactory {
	 ...
	 */
	public abstract StateVertex newStateVertex(int id, String url, String name, String dom, String strippedDom, ArrayList<JavaScriptError> jsErrors);


	/**
	 * @return The index {@link StateVertex}.
	 */
	public StateVertex createIndex(String url, String dom, String strippedDom, ArrayList<JavaScriptError> jsErrors) {
		return newStateVertex(StateVertex.INDEX_ID, url, "index", dom, strippedDom, jsErrors);
	}
}
