...
class StateVertexImpl implements StateVertex {
	...
	StateVertexImpl(int id, String name, String dom) {
		this(id, null, name, dom, dom, new ArrayList<JavaScriptError>());
	}
	 ...
	 */
	public StateVertexImpl(int id, String url, String name, String dom, String strippedDom, ArrayList<JavaScriptError> jsErrors) {
		this.id = id;
		this.url = url;
		this.name = name;
		this.dom = dom;
