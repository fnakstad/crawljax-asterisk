...
public class SerializeTest {
	...
	private OutPutModel createModel() throws IOException {
		ImmutableList<CandidateElementPosition> candidateElements =
		        ImmutableList.of(new CandidateElementPosition("a/b/c", "click", new Point(1, 2),
		                new Dimension(3, 4), "a"));
		State state1 =
		        new State("state1", "http://example.com/a", candidateElements, 1, 1, 1,
		                ImmutableList.of("failedEvent1"), ImmutableList.of(new JavaScriptErrorJson(3, "hey", "hey")));
		State state2 =
		        new State("state2", "http://example.com/b", candidateElements, 1, 1, 1,
		                ImmutableList.of("failedEvent2"), ImmutableList.of(new JavaScriptErrorJson(3, "hey", "hey")));
		...
		ImmutableList<Edge> edges =
		        ImmutableList.of(new Edge(state1.getName(), state2.getName(), 1, "the link",
		                "id1", "A", "click", ImmutableList.of(new JavaScriptErrorJson(3, "hey", "hey"))));
